...
class Catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Pelicula("Ghostbusters Apocalipsis", R.drawable.ghost, R.drawable.ghostbusters, "En Ghostbusters Apocalipsis Fantasma, regresa la familia Spengler a donde todo empezó – la icónica estación de bomberos en Nueva York – donde hace equipo junto con los Ghostbusters originales que han desarrollado un laboratorio de investigación ultrasecreto para llevar la cacería de fantasmas al siguiente nivel. Pero cuando el descubrimiento de un artefacto antiguo libera una fuerza maligna, los nuevos y viejos Ghostbusters unen sus fuerzas para proteger su hogar y salvar al mundo de una segunda era de hielo.", arrayListOf<Cliente>()))
...
class PeliculaAdapter: BaseAdapter {
    ...
    override fun getView(pe: Int, p1: View?, p2: ViewGroup?): View {
        ...
        image.setOnClickListener() {
            ...
            intento.putExtra("seats", (20-pelicula.seats.size))
